...
$(function(){
	$("#updateInfo").click(function(){
		...
		if(organ_code!="-"){
			$.post("${_servlet_url!''}/auth.isused2?organ_code="+organ_code+"&organ_id="+$("#organ_id").val(),{random:Math.random()},
		...
		<col  width="200px"/></col />
			...
			<tr>
					...
					<td class="leftpad">
						...
						<input type="hidden" name="organ_code_image" id="organ_code_image" value="${resultMap.result.organ_code_image!''}">
