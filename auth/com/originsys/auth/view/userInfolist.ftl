...
$(function(){
	...
	jQuery("#clist1").jqGrid({
	   	url:'${_servlet_url!''}/auth.userInfolistdata?mem_state=1',
		datatype: "json",
		width:600,
		height:300,
	   	colNames:[
	...
	jQuery("#gridReload").click(function() {
		var url="${_servlet_url!''}/auth.userInfolistdata"
...
<div id="dialog" title="增加用户" style="display:none">
	<form class="cmxform" style="margin:0" action="${_servlet_url!''}/auth.userInfoadd" method="post" id="addForm">
