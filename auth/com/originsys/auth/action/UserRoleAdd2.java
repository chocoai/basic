 ...
 */
public class UserRoleAdd2 extends BaseAction implements IData {

	public void execute(RequestAction ra, HttpServletResponse response)
			throws Exception {
		String role_id=ra.getParameter("role_id");
		RoleRegister rolereg=AuthRoleService.getInstance().getRoleRegisterBy(role_id,ra.getSite().getSite_id());
		String success="0";
		if(rolereg!=null){
			//获取值
...
//			else
			...
			userRole.setCom_id(ra.getUser().getOrgcom_id());//String:该角色所属的企业 这里不对？、
			userRole.setRole_register_id(rolereg.getRole_register_id());//String:角色注册id
