...
function dosub(type){
	...
	$.post($("#updateform").attr("action"),queryString,
		function(data,textStatus){
			...
			if(jdata.success=="1"){
				alert("修改成功！");
				window.location.href="${_servlet_url!''}/datacenter.resources.editlist?state=7";
			}else{
				alert("修改失败！");
		}
	});
...
<!-- 栏目标题开始 -->
	...
	<div class="widget-content-body">
		...
		<form action="${_servlet_url!''}/datacenter.resources.update" id="updateform" method="post">	
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#a4cff2" style="line-height:30px;">
			<tr>
				<td class="td12">资源名称：</td>
				<td class="td13">
				<input type="hidden" name="resources_id" value="${block.resource.resources_id!''}">
				<input type="text"  name="resources_name" value="${block.resource.resources_name!''}"></td>
				<td class="td12">资源表名：</td>
				<td class="td13"><input type="text" name="resources_tablename" value="${block.resource.resources_tablename!''}"></td>
				<td class="td12">资源类型：</td>
				<td class="td13">
					<select name="resources_type">
					<option value="0" [#if "${block.resource.resources_type!''}"=="0"]selected[/#if]>扩展资源</option>
					<option value="1" [#if "${block.resource.resources_type!''}"=="1"]selected[/#if]>新资源</option>
					</select>
				</td>
			</tr>
			<tr>
				<td class="td12">来源业务系统：</td>
				<td class="td13"><input type="text" name="source_business_systems" value="${block.resource.source_business_systems!''}"></td>
				<td class="td12">资源描述：</td>
				<td class="td13" colspan="3"><input type="text" name="resources_desc" value="${block.resource.resources_desc!''}" size="50"></td>
			</tr>
		</table>
		<table width="100%" border=0 style="line-height:30px;">
		<tr>
		<td style="table_content">列信息</td>
		<td align="right"><button type="button" id="addcol">增加行</button></td>
		</tr></table>
		<table width="100%" id="coltab" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#a4cff2" style="line-height:30px;">
			...
			[#if column_index%2==0]
			<tr>
			<td class="td13"><input type="text" name="column_ename" value="${column.column_ename!''}" onkeyup='clearNoNum(this)'></td>
			<td class="td13"><input type="text" name="column_name" value="${column.column_name!''}"></td>
			<td class="td13"><input type="text" name="column_desc" value="${column.column_desc!''}"></td>
			<td class="td13"><button type='button' onclick='deltr(this);'>删除</button></td>
			</tr>
			[#else]
			<tr>
			<td class="td14"><input type="text" name="column_ename" value="${column.column_ename!''}" onkeyup='clearNoNum(this)'></td>
			<td class="td14"><input type="text" name="column_name" value="${column.column_name!''}"></td>
			<td class="td14"><input type="text" name="column_desc" value="${column.column_desc!''}"></td>
			<td class="td14"><button type='button'  onclick='deltr(this);'>删除</button></td>
			</tr>
			[/#if]
			[/#list]
		</table>
		...
		<td align="right"><button type="button" id="addindex">增加行</button></td>
		</tr></table>
		<table width="100%" id="indextab" border="0" cellpadding="0" cellspacing="1" bgcolor="#a4cff2" style="line-height:30px;">
			...
			<tr>
			<td class="td13"><select name="index_type"><option value="rowkey" selected>rowkey</option></select></td>
			<td class="td13"><input type="text" name="index_column" value="${indexobj.index_column!''}"  onkeyup='clearNoNum2(this)'></td>
			<td class="td13"><input type="text" name="index_separate" value="${indexobj.index_separate!''}" maxlength="1" onkeyup='clearNoNum3(this)' size='2'><span>只能输入#或是|</span></td>
			<td class="td13"><input type="text" name="index_desc" value="${indexobj.index_desc!''}"></td>
			<td class="td13"><button type="button" onclick='deltr(this);'>删除</button></td>
			</tr>
			[#else]
			<tr>
			<td class="td14"><select name="index_type"><option value="rowkey" selected>rowkey</option></select></td>
			<td class="td14"><input type="text" name="index_column" value="${indexobj.index_column!''}" onkeyup='clearNoNum2(this)'></td>
			<td class="td14"><input type="text" name="index_separate" value="${indexobj.index_separate!''}" maxlength="1"  onkeyup='clearNoNum3(this)' size='2'><span>只能输入#或是|</span></td>
			<td class="td14"><input type="text" name="index_desc" value="${indexobj.index_desc!''}"></td>
			<td class="td14"><button type="button" onclick='deltr(this);'>删除</button></td>
			</tr>
			[/#if]
			[/#list]		
