...
/**安全检查员用户类型属性表*/
public class TSafeCensor extends User implements Serializable{
	/**用户id*/
	...
	/**所属责任单位名称*/
	private String manage_scope_name;
	//----------------------------------------------------------------
	...
	public String getManage_scope_name() {
		return manage_scope_name;
	}
	public void setManage_scope_name(String manage_scope_name) {
		this.manage_scope_name = manage_scope_name;
	}
	...
	/**设置的set方法*/
	public void setManage_scope(String manage_scope) {
