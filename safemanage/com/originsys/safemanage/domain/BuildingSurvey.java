...
public class BuildingSurvey {
	private String  building_id;//楼幢编号图斑编号sm_id
	private String  survey_id;//普查编号，主键
	private String  survey_type;//普查类型
	private String  building_holder;//房屋所有人（管理单位）
	private String  building_manager_name;//房屋管理人姓名
	private String  building_manager_phone;//房屋管理人办公室电话、手机
	private String  building_material;//设计施工材料@1、齐全2、基本齐全3、无
	private String  manage_type;//管理模式@1、专业化企业进驻2、后勤式3、社区介入4、业主自治
	private String  build_dept;//建设单位
	private String  design_dept;//设计单位
	private String  building_properties;//房屋性质@1、房改住房2、省直管公房3、市直管公房4、企业自管5、其他
	private String  construct_dept;//施工单位
	private String  local_survey;//现场调查情况
	private String  building_safecondition;//房屋安全情况@1、无危险点房屋2、存在危险点房屋3、局部危险房屋4、整幢危险房屋
	private String  manager_name;//负责人
	private String  survey_name;//排查人
	private Date  survey_date;//排查时间
	private String  check_userid;//审核人id
	private String  info_state;//0 暂存  8提交
	private String  building_address;//坐落
	private Double  build_area;//建筑面积
	private Double build_areamin;//最小建筑面积
	private Double build_areamax;//最大建筑面积
	private Integer  floorup_count;//层数（上）
	private Integer  floordown_count;//层数（下）
	private String  house_count;//套数
	private String  use_desgin;//用途
	private Double  building_date;//建成年份
	private Double building_datestart;//最早建成时间
	private Double building_dateend;//最晚建成时间
	private String  build_struct;//结构类型
	private String  upon_type;//楼盖类型
	private String  wm_type;//屋面类型
	private String  report_userid;//信息填写人id
	private String  check_message;//审核意见
	private Date  check_date;//审核时间
	private String  annex;//附件
	private String  annex_pic;//图片
	private String  building_region;//所属区域
