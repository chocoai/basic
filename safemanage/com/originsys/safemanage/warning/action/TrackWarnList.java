...
/**
 auth:zhanglf 2014-7-21
   描述:危房跟踪预警列表
 */
public class TrackWarnList extends BaseAction implements IGet{
	...
	public DataAndView execute(RequestAction ra) throws Exception {
		...
		String notice_date=ra.getParameter("notice_date");//通知发送时间
		/**组织查询条件对象*/
		...
		if(null!=notice_date&&!"".equals(notice_date)){
			tApp.setNotice_date(sdf.parse(notice_date));
		}
		...
		//获取总条数
		int totalnum=(Integer)sc.queryForObject("safeauth.getTrackWarnCount", tApp);
		//获得总页数
		...
		//查询结果
		List<TAppraisalReport> resultList=(List<TAppraisalReport>)sc.queryForList("safeauth.getTrackWarnList", param);
