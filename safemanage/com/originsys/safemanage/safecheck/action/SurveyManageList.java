...
/**
 auth:zhanglf 2014-5-27
   描述:楼幢普查列表（管理员）
 */
public class SurveyManageList extends BaseAction implements IGet{
...
//		}
		...
		//获取总条数
		int totalnum=(Integer)sc.queryForObject("Safecheck.getSurveyManagerListCount", tBuildingSurvey);
		//获得总页数
		...
		//查询结果
		List<TBuildingSurvey> resultList=(List<TBuildingSurvey>)sc.queryForList("Safecheck.getSurveyManagerList", param);
