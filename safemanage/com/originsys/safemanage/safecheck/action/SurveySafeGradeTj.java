...
public class SurveySafeGradeTj extends BaseAction implements IGet{
	/**
	 * 类说明：楼幢普查各区县安全等级统计楼幢数
	 * @创建时间：2014年6月4日
	 * @作者：zhanglf
	 */
	public DataAndView<Map> execute(RequestAction ra)
		...
		List tmpResult=(List)sc.queryForList("Safecheck.getSafeGradeTj");//从数据库中获取各区县的套数
...
//				Map mm=(Map) l.get(j);
//				System.out.println("---count---"+mm.get("COUNT")+"----safegrade---"+m.get("SAFEGRADE")+"---district---"+mm.get("DISTRICT"));
//			}
//		}
