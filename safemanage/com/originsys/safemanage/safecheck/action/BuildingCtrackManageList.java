...
/**
 auth:zhanglf 2014-5-16
   描述:隐患房屋管理列表
 */
public class BuildingCtrackManageList extends BaseAction implements IGet{
	...
	public DataAndView execute(RequestAction ra) throws Exception {
		...
		//获取总条数
		int totalnum=(Integer)sc.queryForObject("Safecheck.getBuildingCtrackListCount", tBuilding);
		//获得总页数
		...
		//查询结果
		List<TBuilding> resultList=(List<TBuilding>)sc.queryForList("Safecheck.getBuildingCtrackList", param);
