...
public class SafeAssessorsUserList extends BaseAction implements IGet{
	...
	public DataAndView execute(RequestAction ra) throws Exception {
		...
		tSafeAssessors.setMem_name(ra.getParameter("mem_name"));
		tSafeAssessors.setFirstname(ra.getParameter("fullname"));
		...
		//获取总条数
		int totalnum=(Integer)sc.queryForObject("Safecheck.getTSafeAssessorsCount", tSafeAssessors);
		//获得总页数
		...
		param.put("tSafeAssessors", tSafeAssessors);	  
		//查询结果
		List<TSafeAssessors> resultList=(List<TSafeAssessors>)sc.queryForList("Safecheck.getTSafeAssessorsList", param);
