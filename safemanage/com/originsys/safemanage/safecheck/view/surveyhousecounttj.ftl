...
//改表iframe的背景色
   ...
   //拼接chart
	var strXML="<chart palette='1' caption='楼幢普查' subcaption='各区县楼幢数统计' showvalues='0' xAxisName='区县' yAxisName='楼幢数' restoreBtnBorderColor='A2A3A0' formBtnBorderColor='A2A3A0' canvasPadding='20' dragBorderColor='666666' dragBorderThickness='3' baseFontSize='12' chartRightMargin='30' showAboutMenuItem='0' showFormBtn='0' showRestoreBtn='0' >";
	//拼接x轴（categories）
