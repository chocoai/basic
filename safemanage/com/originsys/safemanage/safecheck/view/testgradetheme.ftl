...
$(function(){
//初始化地图
	 map = new FMapLib.FMap("map");//安全鉴定地图
	 $("#testgradetheme").click(function(){
  BT= new FMapLib.BuildingTestGradeUnique(map); //生成安全等级专题图  
     //缩放级别小于3级时自动放大到3级
...
//	var mountArray=[{"A级":183,"B级":13,"C级":15,"D级":140}];//待修改为AJAXS请求服务端返回ＪＳＯＮ数组形式。参考sql：select count(*),t.健康完损等级 from st_ridrgn_jkda_p t group by  t.健康完损等级
	...
	html+="<td width='40' height='7'align='center'>A级 </td></tr>";
	html+="<tr><td width='15'  height='7' bgcolor='"+color[1]+"'></td>";
	html+="<td width='40' height='7'align='center'>B级</td></tr>";
	html+="<tr><td width='15'  height='7' bgcolor='"+color[2]+"'></td>";
	html+="<td width='40' height='7'align='center'>C级</td></tr>";
	html+="<tr><td width='15'  height='7' bgcolor='"+color[3]+"'></td>";
	html+="<td width='40' height='7'align='center'>D级</td></tr>";
	html+="</table></div>" ;
...
<button class="button" id="testgradetheme">生成专题图</button>&nbsp<button class="button" id="cleartheme">清除专题图</button>&nbsp<button class="button" id="printmap">打印地图</button>
</div>
