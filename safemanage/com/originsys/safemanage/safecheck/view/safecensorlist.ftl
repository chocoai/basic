...
$(function(){	
	...
	jQuery("#clist1").jqGrid({
	   	url:'${_servlet_url!''}/safecheck.safecensor.listjson',
		datatype: "json",
		width:600,
		height:300,
	   	colNames:[
	   	...
	   	colModel:[
			...
			,{name:'manage_scope',index:'work_years',sortable:true,hidden:true}
	...
	$("#deleteInfo").click(function(){
		...
		if (id) {
			...
			if(flag){
				...
				$.post("${_servlet_url!''}/safecheck.safecensor.delete?mem_id="+ret.mem_id,"",
	...
	jQuery("#gridReload").click(function() {
		var url="${_servlet_url!''}/safecheck.safecensor.listjson"
	...
	$("#updateInfo").click(function(){
		...
		if (id) { 
			var ret = jQuery("#clist1").jqGrid('getRowData',id);
			$.post("${_servlet_url!''}/safecheck.safecensor.forupdate1?mem_id="+ret.mem_id,"",
				function(data,textStatus){
					var jdata=jQuery.parseJSON(data);
					...
					$("#manage_scope",$("#updateForm")).val(jdata.manage_scope);
...
<div id="dialog" title="安全检查员增加" style="display:none">
	<form class="cmxform" style="margin:0" action="${_servlet_url!''}/safecheck.safecensor.insert" method="post" id="addForm">
		<input type="hidden" name="role_id" value="safecensor">
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;table-layout:fixed;">
			...
			<tr>
					...
					<td class="leftpad" colspan="3">
						...
						<input type="text" name="manage_scope" id="manage_scope" size="32"/>
...
<div id="dialogupdate" title="安全检查员修改" style="display:none">
	<form class="cmxform" style="margin:0" action="${_servlet_url!''}/safecheck.safecensor.update1" method="post" id="updateForm">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;table-layout:fixed;">
			...
			<tr>
					...
					<td class="rightpad" rowspan="2">证书复印件</td>
					<td class="leftpad" rowspan="2">
						<input type="text" name="certificate" id="certificate1"/>
						<!--<input type="hidden" name="certificate" id="certificate" value=""/>
