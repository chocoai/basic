...
public class BuildingBuildAreaHz extends BaseAction implements IGet{
	/**
	 * 类说明：安全检查各区县建筑面积汇总
	 * @创建时间：2014年6月11日
	 * @作者：zhanglf
	...
	public DataAndView<Map> execute(RequestAction ra)
		...
		List tmpResult=(List)sc.queryForList("Safecheck.getPcBuildAreaHz");//从数据库中按年获取各区县的楼幢数
		
		List totalResult=(List)sc.queryForList("Safecheck.getPcBuildAreaGradeHz");//从数据库中按年获取各等级楼幢数
