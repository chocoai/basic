...
$(function(){
	...
	jQuery("#clist1").jqGrid({
		...
		height:270,
	   	...
	   	colModel:[
			...
			,{name:'building_address',index:'building_address',sortable:true,width:140}
			...
			,{name:'linkman',index:'linkman',sortable:true,hidden:true}
			,{name:'linktel',index:'linktel',sortable:true,hidden:true}
	...
	$("#selectInfo").click(function(){
		...
		if (id) { 
			...
			var url="${_servlet_url!''}/safeauth.report.detail?jdinfo_id="+ret.jdinfo_id;	
