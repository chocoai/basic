...
<script type="text/javascript">
	...
	[#list map.relist as relist]
		...
		[#list relist.TYPELIST as typelist]
			strDataset+="<set id='${typelist.YEARJD!''}' value='${typelist.AREA!''}' allowDrag='0'/>";
		[/#list]
		strDataset+="</dataset>";
	[/#list]
