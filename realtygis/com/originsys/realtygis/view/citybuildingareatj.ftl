<!--[#list map.relist as relist]
	...
	[#list relist.TYPELIST as typelist]
		年：${typelist.YEAR!''}面积：${typelist.AREA!''}<br/>
	[/#list]
[/#list]-->
...
<script type="text/javascript">
	...
	[#list map.relist as relist]
		...
		[#list relist.TYPELIST as typelist]
			strDataset+="<set id='${typelist.YEAR!''}' value='${typelist.AREA!''}' allowDrag='0'/>";
		[/#list]
		strDataset+="</dataset>";
	[/#list]
