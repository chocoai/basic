...
<script type="text/javascript">
	...
	//拼接chart
	var strXML="<chart palette='1' caption='全市测绘' subcaption='按年测绘套数统计' showvalues='0' xAxisName='年份' yAxisName='套数' restoreBtnBorderColor='A2A3A0' formBtnBorderColor='A2A3A0' canvasPadding='20' dragBorderColor='666666' dragBorderThickness='3' baseFontSize='12' chartRightMargin='30' showAboutMenuItem='0' showFormBtn='0' showRestoreBtn='0' >";
	//拼接x轴（categories）
	var strCategory="<categories>";
	[#list map.yearList as year]
		strCategory+="<category name='${year!''}年' />";
	[/#list]
	...
	[#list map.relist as relist]
		...
		[#list relist.TYPELIST as typelist]
			strDataset+="<set id='${typelist.YEAR!''}' value='${typelist.COUNT!''}' allowDrag='0'/>";
		[/#list]
		strDataset+="</dataset>";
	[/#list]
