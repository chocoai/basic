...
public class RegionThemeByStructure extends BaseAction implements IGet{
	public DataAndView execute(RequestAction arg0) throws Exception {
		...
		List<HouseHeightRange>lxhousenum=(List)sc.queryForList("Realtygis.regionthemebystructurelx");//从数据库中选择以当前页的起始条数为起点，当前页面显示条数为长度的记录数
		List<HouseHeightRange>szhousenum=(List)sc.queryForList("Realtygis.regionthemebystructuresz");
		List<HouseHeightRange>hyhousenum=(List)sc.queryForList("Realtygis.regionthemebystructurehy");
		List<HouseHeightRange>tqhousenum=(List)sc.queryForList("Realtygis.regionthemebystructuretq");
		List<HouseHeightRange>lchousenum=(List)sc.queryForList("Realtygis.regionthemebystructurelc");
		List<HouseHeightRange>gxhousenum=(List)sc.queryForList("Realtygis.regionthemebystructuregx");
		List<HouseHeightRange>cqhousenum=(List)sc.queryForList("Realtygis.regionthemebystructurecq");
		...
		map.put("lxhousenum",lxhousenum);
		map.put("szhousenum",szhousenum);
		map.put("hyhousenum",hyhousenum);
		map.put("tqhousenum",tqhousenum);
		map.put("lchousenum",lchousenum);
		map.put("gxhousenum",gxhousenum);
		map.put("cqhousenum",cqhousenum);
