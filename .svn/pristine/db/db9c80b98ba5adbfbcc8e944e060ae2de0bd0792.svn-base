...
<div class="widget-content-body">
	<div class="widget-news-content">
		...
		<form method="post" action="${_servlet_url!''}/authclient.client.login" id="form">
			<input type="hidden" name="login_flag" value="1">
			<input type="hidden" name="reDirectURL" value="${_server_url!''}/portal/authclient.client.loginblock">
	    ...
	    <tr>
	      <td height="33" align="center"><input name="Submit5" type="button" class="jr_but_sty" value="退出" onclick="javascript:window.location='${_servlet_url!''}/authclient.loginout';" /></td>
	    </tr>
	   </table>
	</form>
		[/#if]
