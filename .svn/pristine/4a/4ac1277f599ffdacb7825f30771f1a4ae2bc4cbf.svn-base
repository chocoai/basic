...
$(function(){		
	...
	jQuery("#clist1").jqGrid({
	   	url:'${_servlet_url!''}/safemanage.safeassessors.listjson',
		datatype: "json",
		width:600,
		height:300,
	   		colNames:[
	...
	jQuery("#gridReload").click(function() {
		var url="${_servlet_url!''}/safemanage.safeassessors.listjson"
...
function modifyTypeInfo(mem_id){
	window.showModalDialog("${_servlet_url!''}/safemanage.safeassessors.detail?mem_id="+mem_id,"","dialogWidth:600px;dialogHeight:500px;center:1;");
}
</script>
<style>
