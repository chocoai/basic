...
/**
 auth:boy 2014-3-12
   描述：资源编辑列表，根据状态获取不同的列表
 */
public class ResourcesEditList  extends BaseAction implements IGet{
	...
	public DataAndView execute(RequestAction ra) throws Exception {
		...
		//获取总条数
		int totalnum=(Integer)sc.queryForObject("datacenter.getResourcesListCount",state);
		//获得总页数
		...
		param.put("resources_state", state);
		List<YcDatacenterResources> resultList=(List<YcDatacenterResources>)sc.queryForList("datacenter.getResourcesList", param);
