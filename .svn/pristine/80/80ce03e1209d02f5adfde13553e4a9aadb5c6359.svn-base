...
<form action="${_servlet_url!''}/safecheck.disasterwarn.insert" id="addForm" method="post">
<div class="ui-widget ui-widget-content ui-corner-all" style="position: relative;padding: .1em;">
	<div class="ui-widget" id="tabs">
		<input type="hidden" name="smuserid" id="smuserid" value="${block.sbid!''}">
		<input type="hidden" name="smx" id="smx" value="${block.smx!''}">
		<input type="hidden" name="smy" id="smy" value="${block.smy!''}">
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
				<tr>
					...
					<td class="td13"><input type="text" id="disaster_name" name="disaster_name" size="60"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td13">
						<input type="text" size="17" name="disaster_date" id="disaster_date" onClick="WdatePicker()"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td13">
						<textarea cols="60" rows="5" name="disaster_discription"></textarea>
					</td>
				</tr>
				<tr>
					<td class="td12"></td>
