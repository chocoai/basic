...
public class allhousetheme extends BaseAction implements IData{
...
//		Map<String, Object> map=new HashMap<String,Object>();
		...
		if("buildarea".equals(parmas)){
			sqlacrion = "Access.househeight";
		}
		if("builddata".equals(parmas)){
			sqlacrion="Access.buildingdatacount";
		}
		if("buildtype".equals(parmas)){
			sqlacrion="Access.buildingtypecount";
		}
        if("buildstructure".equals(parmas)){
        	...
        	bust.setBrickwood("木");
        	bust.setOther("其");     	
        	sqlacrion="Access.buildingstructurecount";
		}
        if("buildnature".equals(parmas)){
        	sqlacrion="Access.buildingnaturecount";
		 }
        if("builduse".equals(parmas)){
        	sqlacrion="Access.buildingusecount";
        }
