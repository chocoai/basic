 ...
 */
public class ReportListJD extends BaseAction implements  IData{

	@Override
	public void execute(RequestAction ra, HttpServletResponse response)
			throws Exception {

		System.out.println("ReportListJD  ReportListJD");
		...
		if(ra.getParameter("s_date")!=null && !"".equals(ra.getParameter("s_date"))){
			tAppraisalReport.setS_date(sdf.parse(ra.getParameter("s_date")));////Date:鉴定时间
		}
		if(ra.getParameter("e_date")!=null && !"".equals(ra.getParameter("e_date"))){
			tAppraisalReport.setE_date(sdf.parse(ra.getParameter("e_date")));////Date:鉴定时间
		}
		tAppraisalReport.setJdmember(ra.getParameter("jdmember"));//String:鉴定人
		tAppraisalReport.setEntry_mem_id(ra.getParameter("mem_id"));
		...
		if(ra.getServletPath().equals("/exportexcel")){
			...
			System.out.println("_page_start "+start);
			System.out.println("_page_end "+end);
