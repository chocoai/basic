...
$(function(){
	...
	jQuery("#gridReload").click(function() {
		var url="${_servlet_url!''}/safecheck.building.editlistdata?"
	...
	$("#updateInfo").click(function(){
		...
		if (id) { 
			...
			var url="${_servlet_url!''}/safecheck.building.forupdate?building_id="+ret.building_id+"&info_id="+ret.info_id;
	...
	$("#selectInfo").click(function(){
		...
		if (id) { 
			var ret = jQuery("#clist1").jqGrid('getRowData',id);
			window.location="${_servlet_url!''}/safecheck.building.detail?building_id="+ret.building_id+"&info_id="+ret.info_id;	
		}else{
			alert("请选择一条记录！");
		}
	});	
	...
	$("#delete-dialog").dialog({
        ...
        buttons: {
        	'确定': function() {
        		var id = jQuery("#clist1").jqGrid('getGridParam','selrow');
				var ret = jQuery("#clist1").jqGrid('getRowData',id);
				$.post("${_servlet_url!''}/safecheck.building.delete?building_id="+ret.building_id+"&info_id="+ret.info_id,"",function(data,textStatus){
