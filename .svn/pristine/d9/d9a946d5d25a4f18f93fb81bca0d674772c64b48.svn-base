...
<script type="text/javascript" language="javascript">
	$(function(){
		$("#printInfo").click(function(){
			window.location="${_servlet_url!''}/../exportexcel/safecheck.survey.buildareahz";	
		});	
	});
</script>
<style>
...
<table width="100%" border="1" bordercolor="#c5e2ff" cellpadding="0" cellspacing="0" style="border-collapse:collapse;line-height:30px;text-align:center;" align="center">
	<tr><td colspan="6" align="center" bgcolor="#519ce8" class="baida">2014年济南市老楼危楼安全排查汇总表（面积）</td></tr>
	<tr><td style="font-weight:bold;">报表单位：</td><td colspan="5" style="text-align:left;padding-left:10px;">济南市房产测绘研究院</td></tr>
	<tr><td style="font-weight:bold;">项目名称：</td><td colspan="3" style="text-align:left;padding-left:10px;">2014年济南市老楼危楼安全排查</td><td style="font-weight:bold;">填报日期：</td><td>${map.current_time!''}</td></tr>
	...
	<tr><td rowspan="3" bgcolor="#ecf6ff" align="center" class="dahei">序号</td><td rowspan="3" bgcolor="#ecf6ff" align="center" class="dahei">区县名称</td><td colspan="2" bgcolor="#fbfbfb" class="hongzi">排查结果</td><td rowspan="2" bgcolor="#ecf6ff" align="center" class="dahei">合计</td><td rowspan="3" bgcolor="#ecf6ff" align="center" class="dahei">备注</td></tr>
	<tr><td  bgcolor="#ecf6ff" class="lanxiao">无问题房屋</td><td  bgcolor="#ecf6ff" class="lanxiao">有问题房屋</td></tr>
	<tr><td  bgcolor="#f9f9f9">面积（㎡）</td><td  bgcolor="#f9f9f9">面积（㎡）</td><td  bgcolor="#f9f9f9">面积（㎡）</td></tr>
	[#assign index=1]
