...
<form class="cmxform" style="margin:0" action="${_servlet_url!''}/safecheck.repair.add" method="post" id="updateForm">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
		...
		<tr>
			...
			<td class="leftpad">
				<input type="text" name="repair_content" id="repair_content" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>维修费用</td>
			<td class="leftpad">
				<input type="text" name="repair_cost" id="repair_cost" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>维修单位</td>
			<td class="leftpad">
				<input type="text" name="repair_organ" id="repair_organ" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>维修负责人</td>
			<td class="leftpad">
				<input type="text" name="repair_manager" id="repair_manager" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad">负责人电话</td>
			<td class="leftpad">
				<input type="text" name="manager_tel" id="manager_tel" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>完成时间</td>
			<td class="leftpad">
				<input type="text" name="complete_date" id="complete_date" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad">备注</td>
			<td class="leftpad">
				<textarea name="repair_remarks" id="repair_remarks" cols="35" rows="6"></textarea>
			</td>
		</tr>
		<tr>
