...
<form action="${_servlet_url!''}/safecheck.building.insert" id="addForm" method="post">
<input type="hidden" name="building_id" value="${block.sbid!''}">
<input type="hidden" name="floor_count" value="${block.floor_count!''}">
		...
		<div id="tabs-1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
				<tr>
					...
					<td class="td13"><input type="text" name="building_number" value="${block.building_number!''}" size="18"></td>
				</tr>
				<tr>
					<td class="td12"><font color="red">*&nbsp;</font>检查新坐落：</td>
					<td class="td13" colspan="3"><input type="text" id="check_address" name="check_address" size="80" ></td>
					<td class="td12"><font color="red">*&nbsp;</font>坐落是否一致：</td>
					<td class="td13">
						<input type="radio" name="issame" id="issame1" value="1" onclick="changeAddress(1)">&nbsp;是
						<input type="radio" name="issame" id="issame2" value="0" onclick="changeAddress(0)">&nbsp;否
					</td>
				</tr>
				<tr>
					...
					<select id="builiding_region" name="builiding_region">
						...
						<option value="${enum.enum_value!''}" [#if "${block.region!''}"=="${enum.enum_value!''}"]selected[/#if]>${enum.enum_name!''}</option>
						[/#list]
						</select>
					</td>
					<td class="td12">所属街道：</td>
					<td class="td13"><input type="text" id="belong_street" name="belong_street" value="${block.belong_street!''}" size="18"></td>
					<td class="td12">所属小区：</td>
					<td class="td13"><input type="text" id="belong_community" name="belong_community" value="${block.belong_community!''}" size="18"></td>
				</tr>
				<tr>
					<td class="td12">经营管理单位：</td>
					<td class="td13"><input type="text" id="management_unit" name="management_unit" value="${block.management_unit!''}" size="18"></td>
					<td class="td12">建筑面积：</td>
					<td class="td13"><input type="text" id="build_area" name="build_area" value="${block.build_area!''}" size="18"></td>
				...
				<tr>
					...
					<td class="td13"><input type="text" id="owner" name="owner" value="${block.owner!''}" size="18"></td>
				</tr>
				<tr>
					<td class="td12">高度：</td>
					<td class="td13"><input type="text" id="heigth" name="heigth" value="${block.heigth!''}" size="18"></td>
					<td class="td12">檐高：</td>
					<td class="td13"><input type="text" id="depth" name="depth" value="${block.depth!''}" size="18"></td>
					<td class="td12">层高：</td>
					<td class="td13"><input type="text" id="floor_height" name="floor_height" value="${block.floor_height!''}" size="18"></td>
				</tr>
				<tr>
					<td class="td12">平面：</td>
					<td class="td13">
				...
				<tr>
					...
					<td class="td13">
						...
						<option value="${enum.enum_value!''}" [#if "${block.use_design!''}"=="${enum.enum_value!''}"]selected[/#if]>${enum.enum_name!''}</option>
						[/#list]
						</select>
					</td>
					...
					<td class="td13">
						...
						<option value="${enum.enum_value!''}" [#if "${block.real_type!''}"=="${enum.enum_value!''}"]selected[/#if]>${enum.enum_name!''}</option>
						[/#list]
						</select>
					</td>
					...
					<td class="td13">
						<select id="build_struct" name="build_struct">
						    ...
						    <option value="${enum.enum_value!''}" [#if "${block.build_struct!''}"=="${enum.enum_value!''}" ]selected[/#if]>${enum.enum_name!''}</option>
							[/#list]
							[/#if]
						</select>
					</td>
				...
				<tr>
					...
					<td class="td13" colspan="3"><div class="file-box">
						...
						<input type='button' onclick="fileDownload()" id="returnval1" name="returnval1"  class="btn"  style="margin-left:5px;display:none;" value="下载附件"/>
					</div></td>
					<td class="td12">上传图片：</td>
					<td class="td13">
						<input type="hidden" id="annex_pic" name="annex_pic" class='txt'  value="" size="100" readonly="true">
						<button type="button" id="annex_pic_btn">上传图片</button>
					</td>
				</tr>	
				<tr>
		...
		<div id="tabs-2">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
				<tr>
					...
					<td class="td13">
						<input type="radio" name="benormal" value="1" checked>否
						<input type="radio" name="benormal" value="2">是
					</td>
					<td class="td12">沉降裂缝：</td>
					<td class="td13">
						<input type="radio" name="sedi_crack" value="1">否
						<input type="radio" name="sedi_crack" value="2">轻微
						<input type="radio" name="sedi_crack" value="3">一般
						<input type="radio" name="sedi_crack" value="4">严重
					</td>
					<td class="td12">低洼积水：</td>
					<td class="td13">
						<input type="radio" name="low_water" value="1">否
						<input type="radio" name="low_water" value="2" checked>是
					</td>
				</tr>
				<tr>
					<td class="td12">明显倾斜：</td>
					<td class="td13">
						<input type="radio" name="obv_incline" value="1">否
						<input type="radio" name="obv_incline" value="2">是
					</td>
					<td class="td12">其他：</td>
					<td class="td13">
						<input type="radio" name="elseitem" value="1">否
						<input type="radio" name="elseitem" value="2">轻微
						<input type="radio" name="elseitem" value="3">一般
						<input type="radio" name="elseitem" value="4">严重
					</td>
					<td class="td12">&nbsp;</td>
					<td class="td13">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="td13" colspan="5">
						<input type="radio" name="b_grading" value="1">A级
						<input type="radio" name="b_grading" value="2">B级
						<input type="radio" name="b_grading" value="3">C级
						<input type="radio" name="b_grading" value="4">D级
					</td>
				</tr>
				<tr>
					<td class="td12">子项安全评价：</td>
					<td class="td13" colspan="5">
						<input type="radio" name="b_secritygrading" value="1">A级
						<input type="radio" name="b_secritygrading" value="2">B级
						<input type="radio" name="b_secritygrading" value="3">C级
						<input type="radio" name="b_secritygrading" value="4">D级
					</td>
				</tr>
				<tr>
					<td class="td12">子项完损等级评价：</td>
					<td class="td13" colspan="5">
						<input type="radio" name="b_peotected_grage" value="1">完好
						<input type="radio" name="b_peotected_grage" value="2">基本完好
						<input type="radio" name="b_peotected_grage" value="3">一般损坏
						<input type="radio" name="b_peotected_grage" value="4">严重破损
					</td>
				</tr>
				<tr>
					<td class="td13" colspan="6">
					备注：<br>
					<textarea cols="120" rows="5" name="b_tdesc"></textarea>
					</td>
				</tr>
			</table>
		</div>
		<div id="tabs-3">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
				<tr>
					...
					<td class="td12">平地：</td>
					<td class="td13">
						<input type="radio" name="field_flat" value="1">否
						<input type="radio" name="field_flat" value="2" checked>是
					</td>
					<td class="td12">山地：</td>
					<td class="td13">
						<input type="radio" name="field_hillfoot" value="1">否
						<input type="radio" name="field_hillfoot" value="2">是
					</td>
					<td class="td12">悬崖：</td>
					<td class="td13">
						<input type="radio" name="field_cliff" value="1">否
						<input type="radio" name="field_cliff" value="2">是
					</td>
				</tr>
				<tr>
					<td class="td12">水库边：</td>
					<td class="td13">
						<input type="radio" name="field_margin" value="1">否
						<input type="radio" name="field_margin" value="2">是
					</td>
					<td class="td12">低洼地带：</td>
					<td class="td13">
						<input type="radio" name="field_low" value="1">否
						<input type="radio" name="field_low" value="2">是
					</td>
					<td class="td12">塌陷区：</td>
					<td class="td13">
						<input type="radio" name="field_sink" value="1">否
						<input type="radio" name="field_sink" value="2">是
					</td>
				</tr>
				<tr>
					...
					<td class="td13" colspan="5">
						<input type="radio" name="field_earthtype" value="1">硬土
						<input type="radio" name="field_earthtype" value="2" checked>一般
						<input type="radio" name="field_earthtype" value="3">软土
					</td>
				</tr>
				<tr>
					...
					<td class="td12">无异常：</td>
					<td class="td13">
						<input type="radio" name="neighbor_normal" value="1">否
						<input type="radio" name="neighbor_normal" value="2" checked>是
					</td>
					<td class="td12">振动：</td>
					<td class="td13">
						<input type="radio" name="neighbor_shook" value="1">否
						<input type="radio" name="neighbor_shook" value="2">是
					</td>
					<td class="td12">降水：</td>
					<td class="td13">
						<input type="radio" name="neighbor_rain" value="1">否
						<input type="radio" name="neighbor_rain" value="2">是
					</td>
				</tr>
				<tr>
					<td class="td12">土体扰动：</td>
					<td class="td13">
						<input type="radio" name="neighbor_interfere" value="1">否
						<input type="radio" name="neighbor_interfere" value="2">是
					</td>
					<td class="td12">&nbsp;</td>
					<td class="td13">&nbsp;</td>
					<td class="td12">&nbsp;</td>
				...
				<tr>
					...
					<td class="td12">无异常：</td>
					<td class="td13">
						<input type="radio" name="chemic_normal" value="1">否
						<input type="radio" name="chemic_normal" value="2" checked>是
					</td>
					<td class="td12">盐酸：</td>
					<td class="td13">
						<input type="radio" name="chemic_hcl" value="1">否
						<input type="radio" name="chemic_hcl" value="2">是
					</td>
					<td class="td12">硫酸：</td>
					<td class="td13">
						<input type="radio" name="chemic_h2so4" value="1">否
						<input type="radio" name="chemic_h2so4" value="2">是
					</td>
				</tr>
				<tr>
					<td class="td12">海水：</td>
					<td class="td13">
						<input type="radio" name="chemic_seewater" value="1">否
						<input type="radio" name="chemic_seewater" value="2">是
					</td>
					<td class="td12">其他：</td>
					<td class="td13">
						<input type="radio" name="chemic_else" value="1">否
						<input type="radio" name="chemic_else" value="2">是
					</td>
					<td class="td12">&nbsp;</td>
					<td class="td13">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="td13" colspan="5">
						<input type="radio" name="field_grading" value="0">A级
						<input type="radio" name="field_grading" value="1">B级
						<input type="radio" name="field_grading" value="1">C级
					</td>
				</tr>
				<tr>
					<td class="td13" colspan="7">
					备注：<br>
					<textarea cols="120" rows="5" name="field_tdesc"></textarea>
					</td>
				</tr>
			</table>
		</div>
		<div id="tabs-4">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
				...
				<tr>
					...
					<td class="td13" colspan="3">
						<input type="radio" name="health_savegrade" value="1">无危险点房屋
						<input type="radio" name="health_savegrade" value="2">存在危险点房屋
						<input type="radio" name="health_savegrade" value="3">局部危险房屋
						<input type="radio" name="health_savegrade" value="4">整幢危险房屋
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td13"><input type="text" id="check_user" name="check_user" value="${user.fullname!''}"></td>
					<td class="td12"><font color="red">*&nbsp;</font>调查日期：</td>
					<td class="td13"><input type="text" id="check_time" name="check_time"  value="${block.currentdate!''}" onClick="WdatePicker()"></td>
				</tr>
				<!-- tr>
