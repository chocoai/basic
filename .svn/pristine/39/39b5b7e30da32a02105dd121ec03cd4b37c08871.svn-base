...
public class BuildingHouseCountHz extends BaseAction implements IGet{
	/**
	 * 类说明：安全检查各区县楼幢数汇总
	 * @创建时间：2014年6月11日
	 * @作者：zhanglf
	...
	public DataAndView<Map> execute(RequestAction ra)
		...
		List tmpResult=(List)sc.queryForList("Safecheck.getPcHouseCountHz");//从数据库中按年获取各区县的楼幢数
		
		List totalResult=(List)sc.queryForList("Safecheck.getPcHouseCountGradeHz");//从数据库中按年获取各等级楼幢数
