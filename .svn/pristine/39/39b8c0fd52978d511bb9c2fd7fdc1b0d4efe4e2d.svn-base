<link href="${_share_file_url!''}/resource/css/zcps_login.css" rel="stylesheet" type="text/css" />
...
<input type="hidden" name="reDirectURL" value="${_server_url!''}/portal/zcps.zcpsGroupVotelistdata">
