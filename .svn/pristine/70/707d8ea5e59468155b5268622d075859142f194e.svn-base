...
//改表iframe的背景色
   ...
   //拼接chart
   var strXML="<chart palette='2' caption='安全鉴定' subcaption='按等级楼幢数统计' showvalues='0' xAxisName='区县' yAxisName='楼幢数' restoreBtnBorderColor='A2A3A0' formBtnBorderColor='A2A3A0' showFormBtn='0' showRestoreBtn='0' chartRightMargin='30' baseFontSize='12' showAboutmenuItem='0'>";
   //拼接x轴（categories）
