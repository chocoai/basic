...
public class AuthSafeGradeTj extends BaseAction implements IGet{
	/**
	 * 类说明：安全鉴定各区县安全等级统计楼幢数
	 * @创建时间：2014年6月11日
	 * @作者：zhanglf
	 */
	public DataAndView<Map> execute(RequestAction ra)
		...
		List tmpResult=(List)sc.queryForList("Safecheck.getJdSafeGradeTj");//从数据库中按年获取各区县的套数
