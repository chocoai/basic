...
/**
 auth:boy 2014-6-4
   描述：
 */
public class ReportManageList extends BaseAction implements  IGet{
...
//		tAppraisalReport.setLinkman(ra.getParameter("linkman"));//String:联系人
		...
		//获取总条数
		int totalnum=(Integer)sc.queryForObject("safeauth.getTAppraisalReportCount1", tAppraisalReport);
		//获得总页数
		...
		//查询结果
		List<TAppraisalReport> resultList=(List<TAppraisalReport>)sc.queryForList("safeauth.getTAppraisalReportList1", param);
