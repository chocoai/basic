...
public class SurveyBuildAreaHz extends BaseAction implements IGet{
	/**
	 * 类说明：楼幢普查各区县建筑面积汇总
	 * @创建时间：2014年6月5日
	 * @作者：zhanglf
	...
	public DataAndView<Map> execute(RequestAction ra)
		...
		List tmpResult=(List)sc.queryForList("Safecheck.getBuildAreaHz");//从数据库中按年获取各区县的楼幢数
		
		List totalResult=(List)sc.queryForList("Safecheck.getBuildAreaGradeHz");//从数据库中按年获取各等级楼幢数
