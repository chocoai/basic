...
<form class="cmxform" style="margin:0" action="${_servlet_url!''}/safecheck.accident.add" method="post" id="updateForm">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dee2e3" style="line-height:30px;">
		...
		<tr>
			...
			<td class="leftpad">
				<input type="text" name="accident_name" id="accident_name" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>事故发生时间</td>
			<td class="leftpad">
				<input type="text" name="accident_date" id="accident_date" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>事故类型</td>
			<td class="leftpad">
				<input type="text" name="accident_type" id="accident_type" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>事故描述</td>
			<td class="leftpad">
				<textarea name="accident_description" id="accident_description" cols="35" rows="6"></textarea>
			</td>
		</tr>
		<tr>
			<td class="rightpad"><font color="red">*</font>上报人</td>
			<td class="leftpad">
				<input type="text" name="accident_reporter" id="accident_reporter" size="40"/>
			</td>
		</tr>
		<tr>
			<td class="rightpad">备注</td>
			<td class="leftpad">
				<textarea name="accident_note" id="accident_note" cols="35" rows="6"></textarea>
			</td>
		</tr>
		<tr>
