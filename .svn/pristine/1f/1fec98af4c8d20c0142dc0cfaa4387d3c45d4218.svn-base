...
/**
 auth:boy 2014-3-10
   描述：资源注册保存
 */
public class ResourcesRegister extends BaseAction implements IData{
	...
	public void execute(RequestAction ra, HttpServletResponse response)
		...
		ycDatacenterResources.setReg_date(new Date());//Date:注册时间
		ycDatacenterResources.setReg_memid(ra.getUser().getMem_id());//String:注册人id
		...
		try{
			sc.startTransaction();
			sc.insert("datacenter.addYcDatacenterResources",ycDatacenterResources);
