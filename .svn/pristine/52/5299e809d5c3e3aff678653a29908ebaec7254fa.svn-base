...
//改表iframe的背景色
   ...
   //拼接chart
   var strXML="<chart palette='1' paletteColors='FFFF00,FF0000,CC6600,800080,0000CD,006400,008B8B' caption='2014年济南市老楼危楼安全排查' subcaption='房屋结构统计' showvalues='0' xAxisName='区县' yAxisName='楼幢数' restoreBtnBorderColor='A2A3A0' formBtnBorderColor='A2A3A0' showFormBtn='0' showRestoreBtn='0' chartRightMargin='30' baseFontSize='10' showAboutmenuItem='0'>";
   //拼接x轴（categories）
...
[#if "${datta.STRUCT!''}"=="1301"]ids1+="${datta.SMUSERID!''}"+",";[/#if]
[#if "${datta.STRUCT!''}"=="1302"]ids2+="${datta.SMUSERID!''}"+",";[/#if]
[#if "${datta.STRUCT!''}"=="1309"]ids3+="${datta.SMUSERID!''}"+",";[/#if]
[#if "${datta.STRUCT!''}"=="1311"]ids4+="${datta.SMUSERID!''}"+",";[/#if]
[#if "${datta.STRUCT!''}"=="1312"]ids5+="${datta.SMUSERID!''}"+",";[/#if]
[/#list]
