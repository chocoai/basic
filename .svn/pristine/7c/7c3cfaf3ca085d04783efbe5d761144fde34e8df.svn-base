...
public class CitySurveyAreaTj extends BaseAction implements IGet{
	/**
	 * 类说明：全市按年基础测绘面积统计
	 * @创建时间：2014年3月21日
	 * @作者：zhanglf
	...
	public DataAndView<Map> execute(RequestAction ra)
		...
		List surverarea=(List)sc.queryForList("Realtygis.getCitySurveyAreatj", param);//从数据库中按年获取全市的测绘面积
